...
VDG_addAction = {
	_id = _this addAction ["<t color='#888800'>Viewdistance</t>","vdg\scripts\addAction.sqf",[],0,false,true,"","VDG_showAction && (vehicle _this) == _target"];
	_id
};

VDG_onRespawn = {
	waitUntil {!isNull player};
	_id = player addAction ["<t color='#888800'>Viewdistance</t>","vdg\scripts\addAction.sqf",[],0,false,true,"","VDG_showAction && (vehicle _this) ==  _target"];
	_id
};
