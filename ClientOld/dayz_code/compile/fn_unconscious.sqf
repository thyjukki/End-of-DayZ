...
_count = 0;
r_player_unconscious = true; // can be set to false by medEPI.sqf, during the 'while' loop
...
r_player_unconscious = false; player setVariable ["NORRN_unconscious", r_player_unconscious, true]; 
r_player_timeout = 0; player setVariable ["unconsciousTime", r_player_timeout, true]; 
r_player_cardiac = false; player setVariable ["USEC_isCardiac",r_player_cardiac, true]; 
