class RscDisplayGear {
	...
	onUnload = "{player removeMagazines _x} count MeleeMagazines; call player_forceSave; call dayz_meleeMagazineCheck; 	r_ammo_selected_slot = 0; r_ammo_selected_mode = 0;"; /* diag_log 'RscDisplayGear::onunLoad'; */
