class zZombie_Slow_Base : zZombie_Base {
	scope = public;
	glassesEnabled = 0;
	vehicleClass = "Zombie";
...
class z_villager1_slow : zZombie_Slow_Base {
	zombieLoot = "civilian";
...
class z_soldier_slow : zZombie_Slow_Base {
...
class z_soldier_pilot_slow : z_soldier_slow {
...
class z_soldier_heavy_slow : z_soldier_slow {
...
class z_policeman_slow : zZombie_Slow_Base {
...
class z_suit1_slow : zZombie_Slow_Base {
...
class z_suit2_slow : z_suit1_slow {
	zombieLoot = "civilian";
