...
class cfgWeapons {
	...
	class Loot : Default {
		...
		canDrop = false;
		muzzles[] = {this};
		magazines[] = {"ItemBandage", "ItemHeatPack", "PartWoodPile", "PartFueltank", "PartWheel", "PartGeneric", "PartEngine", "PartVRotor", "PartGlass", "ItemWaterbottle", "ItemWaterbottleUnfilled", "ItemEpinephrine", "ItemMorphine", "ItemBloodbag", "ItemAntibiotic", "ItemPainkiller", "ItemJerrycan", "ItemGenerator", "ItemTent", "ItemSandbag", "ItemTankTrap", "ItemWire", "FoodSteakRaw", "TrashTinCan", "ItemSodaLirik", "ItemSodaMtngreen", "FoodEdible", "FoodSteakCooked", "FoodCanBakedBeans", "FoodCanSardines", "FoodCanFrankBeans", "FoodCanPasta"};
		modes[] = {this};
		useAction = false;
		useActionTitle = "";
		enableAttack = false;
...
class CfgMagazines {
	...
	class TrapBear : CA_Magazine {
		...
		class ItemActions {
			class Build {
				...
				script = "; ['TrapBear','Build'] spawn player_build; r_action_count = r_action_count + 1;";
				require[] = {"ItemToolbox"};
				consume[] = {"TrapBear"};
				create = "BearTrap_DZ";
			};
	...
	class ItemTrapBearTrapFlare : CA_Magazine {
		...
		class ItemActions {
			class Build {
				text = $STR_ACTION_BUILD;
				script = "; ['ItemTrapBearTrapFlare','Build'] spawn player_build; r_action_count = r_action_count + 1;";
				require[] = {"ItemToolbox"};
	...
	class ItemTrapBearTrapSmoke : CA_Magazine {
		...
		class ItemActions {
			class Build {
				text = $STR_ACTION_BUILD;
				script = "; ['ItemTrapBearTrapSmoke','Build'] spawn player_build; r_action_count = r_action_count + 1;";
				require[] = {"ItemToolbox"};
	...
	class ItemTrapTripwireCans : CA_Magazine {
		...
		class ItemActions {
			class Build {
				text = $STR_ACTION_BUILD;
				script = "; ['ItemTrapTripwireCans','Build'] spawn player_build; r_action_count = r_action_count + 1;";
				require[] = {"ItemToolbox"};
	...
	class ItemTrapTripwireFlare : CA_Magazine {
		...
		class ItemActions {
			class Build {
				text = $STR_ACTION_BUILD;
				script = "; ['ItemTrapTripwireFlare','Build'] spawn player_build; r_action_count = r_action_count + 1;";
				require[] = {"ItemToolbox"};
	...
	class ItemTrapTripwireGrenade : CA_Magazine {
		...
		class ItemActions {
			class Build {
				text = $STR_ACTION_BUILD;
				script = "; ['ItemTrapTripwireGrenade','Build'] spawn player_build; r_action_count = r_action_count + 1;";
				require[] = {"ItemToolbox"};
	...
	class ItemTrapTripwireSmoke : CA_Magazine {
		...
		class ItemActions {
			class Build {
				text = $STR_ACTION_BUILD;
				script = "; ['ItemTrapTripwireSmoke','Build'] spawn player_build; r_action_count = r_action_count + 1;";
				require[] = {"ItemToolbox"};
...
class ItemSodaEmpty;
	...
	class FoodEdible : CA_Magazine {
		...
		class ItemActions {
			class Eat {
				text = $STR_EAT_FOOD; //$STR_EAT_FOOD
	...
	//Food includes
	#include "configs\FoodEdible.hpp"
	#include "configs\FoodCooked.hpp"
	#include "configs\FoodRaw.hpp"
	#include "configs\ItemSoda.hpp"
	#include "configs\ItemSodaEmpty.hpp"
	...
	class ItemChloroform: CA_Magazine
	{
		...
		count=1;
		type=256;
		displayName="$STR_EQUIP_NAME_CODE_48";
		picture="\dayz_equip\textures\equip_chloroform_ca.paa";
		descriptionShort="$STR_EQUIP_DESC_CODE_48";
	};
	...
	class ItemGenerator : CA_Magazine {
		...
		class ItemActions {
			class Build {
				text = $STR_ACTION_BUILD;
				script = "; ['ItemGenerator','Build'] spawn player_build; r_action_count = r_action_count + 1;";
				require[] = {"ItemEtool"};
	...
	class ItemTent : CA_Magazine {
		...
		class ItemActions {
			...
			class Build {
				text = $STR_PITCH_TENT;
				script = "; ['ItemTent','Build'] spawn player_build; r_action_count = r_action_count + 1;";
				require[] = {};
				consume[] = {"ItemTent"};
				create = "TentStorage";
			};
	...
	class ItemDomeTent : CA_Magazine {
		...
		class ItemActions {
			class Build {
				...
				script = "; ['ItemDomeTent','Build'] spawn player_build; r_action_count = r_action_count + 1;";
				require[] = {};
	...
	class ItemCamoNet : CA_Magazine {
		...
		class ItemActions {
			class Build {
				...
				script = "; ['ItemCamoNet','Build'] spawn player_build; r_action_count = r_action_count + 1;";
				require[] = {"ItemToolbox"};
				consume[] = {"ItemCamoNet"};
				create = "CamoNet_DZ";
			};
	...
	class ItemCamoNetGrey : CA_Magazine {
		scope = public;
		count = 1;
		type = (256 * 3);
		displayName = $STR_ITEM_NAME_CAMONET;
	...
	class ItemSandbag : CA_Magazine {
		...
		class ItemActions {
			class Build {
				text = $STR_ACTION_BUILD;
				script = "; ['ItemSandbag','Build'] spawn player_build; r_action_count = r_action_count + 1;";
				require[] = {"ItemEtool"};
				consume[] = {"ItemSandbag"};
				create = "Sandbag1_DZ";
	...
	class ItemTankTrap : CA_Magazine {
		...
		class ItemActions {
			class Build {
				text = $STR_ACTION_BUILD;
				script = "; ['ItemTankTrap','Build'] spawn player_build; r_action_count = r_action_count + 1;";
				require[] = {"ItemToolbox"};
	...
	class ItemWire : CA_Magazine {
		...
		class ItemActions {
			class Build {
				text = $STR_ACTION_BUILD;
				script = "; ['ItemWire','Build'] spawn player_build; r_action_count = r_action_count + 1;";
				require[] = {"ItemToolbox"};
				consume[] = {"ItemWire"};
				create = "Wire_cat1";
				byPass = "byPassRoadCheck";
