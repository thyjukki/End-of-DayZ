...
class CfgAmmo
{
	...
	class BulletCore;
	class BulletBase;
	class UKF_859x70_round: BulletBase
	{
		hit=22;
		indirectHit=2;
...
class CfgMagazines
{
	...
	{
		scope=2;
		displayName=".338 Lapua";
		ammo="UKF_859x70_round";
		ACE_WEIGHT=0.550000;
		count=5;
		initSpeed=936;
		picture="\UKF_L115A3\Equip\m_UKF_338Mag_ca.paa";
		descriptionShort=".338 Lapua, 5 Rounds";
	};
};
class CfgRecoils
{
...
class CfgVehicleClasses
{
	class UKF_Snipers
	{
		displayName="UKF Snipers";
	};
};
class CfgVehicles
{
	class USMC_SoldierS_Sniper;
	class UKF_sniper: USMC_SoldierS_Sniper
	{
		displayName="Sniper (L115A3)";
		vehicleClass="UKF_Snipers";
	...
	class UKF_sniper_wdl: UKF_sniper
	{
		displayName="Sniper (L115A3 WD)";
		vehicleClass="UKF_Snipers";
		faction="UK_ARMED_FORCES";
		weapons[]=
		{
	...
	class UKF_sniper_des: UKF_sniper
	{
		displayName="Sniper (L115A3 Des)";
		vehicleClass="UKF_Snipers";
		faction="UK_ARMED_FORCES";
		weapons[]=
		{
	...
	class UKF_sniper_sd: USMC_SoldierS_Sniper
	{
		displayName="Sniper (L115A3 SD)";
		vehicleClass="UKF_Snipers";
		faction="UK_ARMED_FORCES";
		weapons[]=
		{
	...
	class UKF_sniper_wdl_sd: UKF_sniper_sd
	{
		displayName="Sniper (L115A3 WD SD)";
		vehicleClass="UKF_Snipers";
		faction="UK_ARMED_FORCES";
		weapons[]=
		{
	...
	class UKF_sniper_des_sd: UKF_sniper_sd
	{
		displayName="Sniper (L115A3 Des SD)";
		vehicleClass="UKF_Snipers";
		faction="UK_ARMED_FORCES";
		weapons[]=
		{
	...
	class FxCartridge;
	class UKFCartridge_338: FxCartridge
	{
		model="\UKF_L115A3\338cart.p3d";
	};
	class USBasicWeaponsBox;
	class ukf_SniperBox_1: USBasicWeaponsBox
	{
		displayName="UKF Sniper Rifles";
		class TransportMagazines
		{
			class _xx_UKF_5Rnd_338_Mag
			{
				magazine="UKF_5Rnd_338_Mag";
				count=90;
			};
		};
		class TransportWeapons
		{
			class _xx_UKF_L115A3
			{
				weapon="UKF_L115A3";
				count=3;
			};
			class _xx_UKF_L115A3_wdl
			{
				weapon="UKF_L115A3_wdl";
				count=3;
			};
			class _xx_UKF_L115A3_des
			{
				weapon="UKF_L115A3_des";
				count=3;
			};
			class _xx_UKF_L115A3_sd
			{
				weapon="UKF_L115A3_sd";
				count=3;
			};
			class _xx_UKF_L115A3_sd_wdl
			{
				weapon="UKF_L115A3_sd_wdl";
				count=3;
			};
			class _xx_UKF_L115A3_sd_des
			{
				weapon="UKF_L115A3_sd_des";
				count=3;
			};
		};
	};
...
class Extended_PreInit_EventHandlers
{
	class UKF_L115
	{
		clientInit="[] execVM '\UKF_L115A3\s\XEH_preClientInit.sqf'";
	};
};
class Extended_PostInit_EventHandlers
{
	class UKF_L115
	{
		clientInit="[] execVM '\UKF_L115A3\s\XEH_postClientInit.sqf'";
	};
};
