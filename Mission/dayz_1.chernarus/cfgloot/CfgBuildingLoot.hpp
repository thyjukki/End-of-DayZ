...
class CfgBuildingLoot {
	...
	class Industrial: Default { //254
		...
		//one spawn
			...
			{"ItemBlueprint2",				"magazine",0,01},
			{"ItemBlueprint3",				"magazine",0,01},
			{"ItemBlueprint4",				"magazine",0,01},
			{"ItemBlueprint5",				"magazine",0,01},
			{"ItemWallBlueprint1",			"magazine",0,01},
	...
	class HeliCrashEAST: Default {
		...
		//Assault rifles
			...
			{"VIL_AMD",						"weapon",3.05},
			{"VIL_AKS_47",					"weapon",3.10},
			{"VIL_AK_47",					"weapon",3.10},
			{"VIL_AKM",						"weapon",3.10},
			{"VIL_AKM_GL",					"weapon",3.10},
			{"VIL_AKMS",					"weapon",3.10},
			{"VIL_AKMS_GL",					"weapon",3.10},
			{"VIL_AK_74",					"weapon",3.10},
			{"VIL_AK_74M_PSO",				"weapon",3.10},
			{"VIL_AKS_74_GP",				"weapon",3.10},
			{"VIL_AKS_74p",					"weapon",3.10},
			{"VIL_AK_74M",					"weapon",3.10},
			{"VIL_AK_74M_C ",				"weapon",3.10},
			{"VIL_AK_74M_p29",				"weapon",3.10},
			{"VIL_AK_74M_GP_29",			"weapon",3.10},
			{"VIL_AK_74M_GP",				"weapon",3.10},
			{"VIL_AK_74_GP",				"weapon",3.10},
			{"VIL_AK_107",					"weapon",3.10},
			{"VIL_AK_107_C",				"weapon",3.10},
			{"VIL_AEK_GL",					"weapon",3.10},
			{"VIL_ABAKAN",					"weapon",3.10},
			{"VIL_ABAKAN_GP",				"weapon",3.10},
			{"VIL_ABAKAN_P29",				"weapon",3.10},
			{"VIL_AKS_74_u",				"weapon",3.10},
			{"VIL_AK_105",					"weapon",3.10},
			{"VIL_AK_105_C",				"weapon",3.10},
		//Attachements
