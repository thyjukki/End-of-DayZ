...
class CfgBuildingLoot {
	...
	class HeliCrashWEST: Default {
		...
		//5.56
			...
			{"RH_Scarl",					"weapon",0.50},
			{"RH_Scarl_aim",				"weapon",0.57},
			{"RH_Scarl_acog",				"weapon",0.24},
			{"RH_Scarl_eotech",				"weapon",0.57},
			...
			//{"RH_hk416",					"weapon",0.58}, //We dont have this pack yet, uncommenting when we do
		...
		///7.62x51mm/Heavy Weapons
			...
			//{"DGR_M24_A2",					"weapon",0.30}, //We dont have this pack yet, uncommenting when we do
